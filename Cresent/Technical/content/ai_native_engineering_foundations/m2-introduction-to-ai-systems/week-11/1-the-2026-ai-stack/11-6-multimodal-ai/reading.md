<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Cresent view of 11.6 — Multimodal AI.
     Source of truth: CIT 4.6.
     Regenerate: python Cresent/Technical/tools/generate_shared_readings.py -->
<!-- nav:top:start -->
Previous: [⬅ 11.5 — Tool Use](../11-5-tool-use/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../README.md#part-b)&emsp;·&emsp;[12.1 — Why the Same Question Gives Different Answers ➡](../../../week-12/1-how-llms-behave/12-1-why-the-same-question-gives-different-answers/reading.md)
<!-- nav:top:end -->
...
![How a multimodal model works](../../../../../../../../CIT/content-gen-example/content/m2-introduction-to-ai-systems/week-4/3-multimodal-ai/4-6-multimodal-ai-working-with-text-image-audio-and-video-in-one/artifacts/diagram.png)
