<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Cresent view of 11.4 — Agents (Concept).
     Source of truth: CIT 4.4.
     Regenerate: python Cresent/Technical/tools/generate_shared_readings.py -->
<!-- nav:top:start -->
Previous: [⬅ 11.3 — RAG (Concept)](../11-3-rag-concept/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../README.md#part-b)&emsp;·&emsp;[11.5 — Tool Use ➡](../11-5-tool-use/reading.md)
<!-- nav:top:end -->
...
![Agent architecture — observe, think, act loop](../../../../../../../../CIT/content-gen-example/content/m2-introduction-to-ai-systems/week-4/2-retrieval-agents-and-tools/4-4-agents-llm-plus-memory-tools-and-a-planning-loop-conceptual/artifacts/diagram.png)
