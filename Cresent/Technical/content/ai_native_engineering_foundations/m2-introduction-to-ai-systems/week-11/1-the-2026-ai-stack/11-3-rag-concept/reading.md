<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Cresent view of 11.3 — RAG (Concept).
     Source of truth: CIT 4.3.
     Regenerate: python Cresent/Technical/tools/generate_shared_readings.py -->
<!-- nav:top:start -->
Previous: [⬅ 11.2 — Fine-Tuning](../11-2-fine-tuning/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../README.md#part-b)&emsp;·&emsp;[11.4 — Agents (Concept) ➡](../11-4-agents-concept/reading.md)
<!-- nav:top:end -->
...
![The RAG pipeline: user question flows through Retrieve → Augment → Generate to produce a grounded answer.](../../../../../../../../CIT/content-gen-example/content/m2-introduction-to-ai-systems/week-4/2-retrieval-agents-and-tools/4-3-retrieval-augmented-generation-rag-giving-ai-access-to-exter/artifacts/diagram.png)
