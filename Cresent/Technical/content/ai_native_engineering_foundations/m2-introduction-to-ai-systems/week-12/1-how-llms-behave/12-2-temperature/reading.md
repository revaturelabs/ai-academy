<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Cresent view of 12.2 — Temperature.
     Source of truth: CIT 7.5.
     Regenerate: python Cresent/Technical/tools/generate_shared_readings.py -->
<!-- nav:top:start -->
Previous: [⬅ 12.1 — Why the Same Question Gives Different Answers](../12-1-why-the-same-question-gives-different-answers/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../README.md#part-b)&emsp;·&emsp;[12.3 — Probability Distributions ➡](../12-3-probability-distributions/reading.md)
<!-- nav:top:end -->
...
![Temperature distribution diagram](../../../../../../../../CIT/content-gen-example/content/m3-applied-maths-for-ai/week-7/2-how-llms-use-probability/7-5-temperature-low-picks-the-most-likely-token-high-introduces/artifacts/diagram.png)
