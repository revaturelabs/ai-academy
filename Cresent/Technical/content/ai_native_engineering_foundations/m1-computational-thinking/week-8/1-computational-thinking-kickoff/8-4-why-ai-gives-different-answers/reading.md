<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Cresent view of 8.4 — Why AI Gives Different Answers.
     Source of truth: CIT 1.4.
     Regenerate: python Cresent/Technical/tools/generate_shared_readings.py -->
<!-- nav:top:start -->
Previous: [⬅ 8.3 — What Is Computation](../8-3-what-is-computation/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../README.md#part-b)&emsp;·&emsp;[8.5 — Human vs Machine Problem-Solving ➡](../8-5-human-vs-machine-problem-solving/reading.md)
<!-- nav:top:end -->
...
![Token-by-token sampling chain with low vs high temperature contrast](../../../../../../../../CIT/content-gen-example/content/m1-computational-thinking/week-1/1-understanding-computation/1-4-why-ai-gives-different-answers-to-the-same-question/artifacts/diagram.png)
