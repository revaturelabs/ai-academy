<!-- nav:top:start -->
[⬅ Previous: 5.5 — Red-teaming](../../5-5-red-teaming-systematically-testing-your-own-system-for-failu/artifacts/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../../README.md#curriculum-topic-index)&emsp;·&emsp;[Next: 5.7 — EU AI Act ➡](../../../4-governance-frameworks/5-7-eu-ai-act-risk-tiers-unacceptable-high-limited-minimal-risk/artifacts/reading.md)
<!-- nav:top:end -->
...
![Prompt injection: trusted and untrusted text merge into one context window and can hijack the output](./diagram.png)
