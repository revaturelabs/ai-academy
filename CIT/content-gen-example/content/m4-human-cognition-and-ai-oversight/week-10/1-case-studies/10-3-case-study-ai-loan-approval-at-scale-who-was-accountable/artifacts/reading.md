<!-- nav:top:start -->
[⬅ Previous: 10.2 — Case study: Automated medical triage](../../10-2-case-study-automated-medical-triage-what-failure-mode-was-to/artifacts/reading.md)&emsp;·&emsp;[⬆ Table of Contents](../../../../../../../README.md#curriculum-topic-index)&emsp;·&emsp;[Next: 10.4 — Automation complacency ➡](../../../2-automation-complacency/10-4-automation-complacency-how-high-accuracy-makes-humans-less-v/artifacts/reading.md)
<!-- nav:top:end -->
...
![AI loan approval pipeline with accountability gaps and controls](./diagram.png)
